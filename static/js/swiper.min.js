...
!(function(e, t) {
  ...
  let n = { components: { configurable: !0 } }
  ;(s.prototype.on = function(e, t, a) {
    ...
    (s.installModule = function(t) {
      ...
      const s = t.name || Object.keys(i.prototype.modules).length + '_' + ee.now()
      return (
            ...
            if (t.slidesPerView === 'auto') {
              ...
              if (
                ...
                let A = parseFloat(I.getPropertyValue('width'));
                  var N = parseFloat(I.getPropertyValue('padding-left'));
                  var H = parseFloat(I.getPropertyValue('padding-right'));
                ...
                T = X && X === 'border-box' ? A + G + B : A + N + H + G + B
              } else {
    ...
    loopCreate() {
      ...
      if (e.loopFillGroupWithBlank) {
        ...
        if (a !== e.slidesPerGroup) {
          for (let r = 0; r < a; r += 1) {
            let n = L(f.createElement('div')).addClass(
        ...
        if (!t.animating || !i.preventInteractionOnTransition) {
          ...
          if (
            ...
            if (
              ...
              ;(s.currentX =
                r.type === 'touchstart' ? r.targetTouches[0].pageX : r.pageX),
                (s.currentY =
                  r.type === 'touchstart' ? r.targetTouches[0].pageY : r.pageY)
              let n = s.currentX;
                var o = s.currentY;
                var l = i.edgeSwipeDetection || i.iOSEdgeSwipeDetection;
        ...
        (e.onTouchMove = function(e) {
          ...
          if ((n.originalEvent && (n = n.originalEvent), a.isTouched)) {
            if (!a.isTouchEvent || n.type !== 'mousemove') {
              let o =
                  n.type === 'touchmove' ? n.targetTouches[0].pageX : n.pageX;
                var l = n.type === 'touchmove' ? n.targetTouches[0].pageY : n.pageY
                        ...
                        ? ((h = !1),
                          i.resistance &&
                            (a.currentTranslate =
                              t.minTranslate() -
                              1 +
                              (-t.minTranslate() + a.startTranslate + u) ** v))
                        : u < 0 &&
                          ...
                          i.resistance &&
                            (a.currentTranslate =
                              t.maxTranslate() +
                              1 -
                              (t.maxTranslate() - a.startTranslate - u) ** v)),
          ...
          if (
            ...
            if (i.freeModeMomentum) {
              ...
              let y;
                var x;
                var T = !1;
                var E = 20 * Math.abs(t.velocity) * i.freeModeMomentumBounceRatio
              if (w < t.maxTranslate())
  ...
  var S = (function(u) {
    function h() {
      ...
      if ((t = o[0])) {
        ...
        var d;
            var p;
            var c = o.children('.' + r.params.wrapperClass)
        return (
          ee.extend(r, {
            $el: o,
            el: t,
      ...
      (h.prototype.update = function() {
        ...
        function i() {
          var e = a.rtlTranslate ? -1 * a.translate : a.translate;
              var t = Math.min(Math.max(e, a.maxTranslate()), a.minTranslate())
  ...
  var C = { name: 'device', proto: { device: m }, static: { device: m } }
  var M = { name: 'support', proto: { support: te }, static: { support: te } }
  var k = { name: 'browser', proto: { browser: I }, static: { browser: I } }
  let P = {
    name: 'resize',
    create: function() {
      let e = this
  ...
  let D = {
    update: function(e) {
      ...
      let y = Math.max((w || 0) - b, 0);
          var x = Math.min((w || 0) + g, u.length - 1);
          var T = (t.slidesGrid[y] || 0) - (t.slidesGrid[0] || 0)
      function E() {
        t.updateSlides(),
          t.updateProgress(),
          t.updateSlidesClasses(),
  ...
  var H = {
    ...
    event:
      J.navigator.userAgent.includes('firefox')
        ? 'DOMMouseScroll'
        : (function() {
            let e = 'onwheel'
            let t = e in f
  ...
  let X = {
    ...
    disableDraggable: function() {
      ...
      if (e.params.scrollbar.el) {
        var t = e.scrollbar;
            var a = e.touchEventsTouch;
            var i = e.touchEventsDesktop;
            var s = e.params;
            var r = t.$el[0];
            var n = !(!te.passiveListener || !s.passiveListeners) && {
              passive: !1,
              capture: !1
            };
            var o = !(!te.passiveListener || !s.passiveListeners) && {
            passive: !0,
            capture: !1
          }
        te.touch
    ...
    setHistory: function(e, t) {
      if (this.history.initialized && this.params.history.enabled) {
        var a = this.slides.eq(t);
            var i = W.slugify(a.attr('data-history'))
  ...
  let Q = {
    setTranslate: function() {
      for (
        ...
        var v = i.eq(u);
            var f = r[u];
            var m = ((d - v[0].swiperSlideOffset - f / 2) / f) * n.modifier;
            var g = o ? p * m : 0;
            var b = o ? 0 : p * m;
            var w = -c * Math.abs(m);
            var y = o ? 0 : n.stretch * m;
            var x = o ? n.stretch * m : 0
    ...
    },
    {
      ...
      create() {
        ...
        Object.defineProperty(i.zoom, 'scale', {
          ...
          set: function(e) {
            if (s !== e) {
              let t = i.zoom.gesture.$imageEl
                  ? i.zoom.gesture.$imageEl[0]
                  : void 0;
                  var a = i.zoom.gesture.$slideEl
