...
!(function(e, t) {
        ...
        pseudos: {
          ...
          contains: se(function(e) {
            return (
              (e = e.replace(Z, ee)),
              function(t) {
                return (t.textContent || t.textContent || i(t)).includes(e)
              }
            )
          }),
          lang: se(function(e) {
  ...
  w.fn.extend({
    ...
    hasClass(e) {
      ...
      t = ' ' + e + ' '
      while ((n = this[r++]))
        if (n.nodeType === 1 && (' ' + vt(mt(n)) + ' ').includes(t)) return !0
      return !1
    }
  })
  const bt = /\r/g
    ...
    trigger(t, n, i, o) {
      ...
      if (
        ...
        i.nodeType !== 3 &&
          ...
          (m.includes('.') && ((m = (x = m.split('.')).shift()), x.sort()),
          (c = !m.includes(':') && 'on' + m),
    ...
    (w.offset = {
      setOffset(e, t, n) {
        ...
        c === 'static' && (e.style.position = 'relative'),
          ...
          (o = w.css(e, 'top')),
          (u = w.css(e, 'left')),
          (l = (c === 'absolute' || c === 'fixed') && (o + u).includes('auto'))
